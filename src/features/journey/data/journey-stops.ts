...
export const JOURNEY_STOPS = [
  ...
  { id: JOURNEY_ANCHORS.korea, year: 2024, label: '4e année', title: 'Séoul, Korea University' },
  {
    id: 'annee-2025',
    year: 2025,
    label: '5e année',
    title: 'Retour en France',
    note: 'De retour en France, je rejoins IT-Finance, éditeur de ProRealTime. Avec l’équipe de STAXX, nous passons sur NRJ Lille, puis remportons l’Epitech Summit.',
  },
  {
    id: 'annee-2026',
    year: 2026,
    label: 'Promo 2026',
    title: 'Aujourd’hui',
    note: 'Promo 2026 d’Epitech. Software Engineer chez IT-Finance, éditeur de ProRealTime.',
  },
